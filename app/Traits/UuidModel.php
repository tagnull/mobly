 ...
 * https://medium.com/@steveazz/setting-up-uuids-in-laravel-5-552412db2088#.a9bsatff8
 * https://github.com/binarycabin/laravel-uuid/blob/master/src/Traits/HasUUID.php
 */
...
trait UuidModel
{
    ...
    public static function bootUuidModel()
    {
        ...
        static::saving(function ($model) {
            //die('UuidModel@bootUuidModel::saving');
